...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-02-2020 a las 22:58:04
...
CREATE TABLE `asignar` (
  ...
  `consecuitivo_asignar` varchar(30) NOT NULL,
...
INSERT INTO `asignar` (`id_asignar`, `consecuitivo_asignar`, `fecha_asignacion`, `fkID_tipo_movimiento`, `fkID_persona_entrega`, `fkID_persona_recibe`, `fkID_proyecto`, `observacion`, `url_acta`, `estado`) VALUES
(1, '', '2020-01-31', 1, 1, 16, 10, 'prueba', '', 1),
(2, '', '2020-02-12', 1, 1, 10, 10, '', '', 1);
