...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-02-2020 a las 21:10:36
...
CREATE TABLE `asignacion_equipo` (
  ...
  `fkID_asignación` int(11) NOT NULL,
...
INSERT INTO `asignacion_equipo` (`id_asignacion_equipo`, `fkID_asignación`, `fkID_equipo`, `estado`) VALUES
(1, 1, 19, 1),
(2, 1, 20, 1),
(3, 1, 21, 1),
(4, 1, 22, 1),
...
CREATE TABLE `asignar` (
  ...
  `consecutivo_asignar` varchar(30) NOT NULL,
...
INSERT INTO `asignar` (`id_asignar`, `consecutivo_asignar`, `fecha_asignacion`, `fkID_tipo_movimiento`, `fkID_persona_entrega`, `fkID_persona_recibe`, `fkID_proyecto`, `observacion`, `url_acta`, `estado`) VALUES
(1, 'AL-1', '2020-02-11', 1, 1, 2, 10, 'carga', '', 1),
(2, 'AF-1', '2020-02-05', 4, 1, 13, 10, 'prueba', '', 1),
(3, 'AL-3', '2020-02-28', 1, 1, 5, 5, 'claro', '', 1),
(4, 'AL-4', '2020-02-05', 1, 1, 2, 6, 'retu', '', 1),
(13, 'AL-13', '2020-02-18', 1, 1, 4, 39, 'zxer', '', 1);
...
(23, 'QW232', 1, 4, 3, 1, 2, '', 1),
(24, 'QQ231W', 2, 2, 7, 1, 2, '', 1);
...
(1, '2020-02-11', 19, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-1', 0),
(2, '2020-02-11', 20, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-1', 0),
(3, '2020-02-11', 21, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-1', 0),
(4, '2020-02-11', 22, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-1', 0),
(5, '2020-02-11', 23, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-1', 0),
(6, '2020-02-11', 24, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-1', 0),
(7, '2020-02-11', 19, 1, 9, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-2', 0),
(8, '2020-02-11', 20, 1, 9, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-2', 0),
(9, '2020-02-11', 21, 1, 9, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-2', 0),
(10, '2020-02-11', 22, 1, 9, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-2', 0),
(11, '2020-02-11', 23, 1, 9, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-2', 0),
(12, '2020-02-11', 24, 1, 9, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-2', 0),
(13, '2020-02-28', 19, 1, 5, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-3', 0),
(14, '2020-02-28', 20, 1, 5, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-3', 0),
(15, '2020-02-28', 21, 1, 5, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-3', 0),
(16, '2020-02-28', 22, 1, 5, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-3', 0),
(17, '2020-02-28', 23, 1, 5, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-3', 0),
(18, '2020-02-28', 24, 1, 5, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-3', 0),
(19, '2020-02-05', 19, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-4', 0),
(20, '2020-02-05', 20, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-4', 0),
(21, '2020-02-05', 21, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-4', 0),
(22, '2020-02-05', 22, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-4', 0),
(23, '2020-02-05', 23, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-4', 0),
(24, '2020-02-05', 24, 1, 2, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-4', 0),
(25, '2020-02-18', 14, 1, 4, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-13', 0),
(26, '2020-02-18', 15, 1, 4, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-13', 0),
(27, '2020-02-18', 16, 1, 4, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-13', 0),
(28, '2020-02-18', 17, 1, 4, 1, NULL, 'ASIGNACIÓN POR LOTE DEL EQUIPO', 'AL-13', 0);
...
(5, 23, 1, 0, NULL, NULL, NULL, 'CREACIÓN DE EQUIPO', 1),
(6, 24, 1, 0, NULL, NULL, NULL, 'CREACIÓN DE EQUIPO', 1);
...
(13, 'CARDENAS', 'LUIS', '786768', '34556765', '3120987876', 'JKHKUY@HOTMAIL.COM', 10, 1, 1, 4, 1, 1, 1),
...
CREATE TABLE `tipo_movimiento` (
  ...
  `conse_tipo_movimiento` varchar(45) DEFAULT NULL,
...
INSERT INTO `tipo_movimiento` (`id_tipo_movimiento`, `inicial_tipo_movimiento`, `conse_tipo_movimiento`, `nombre_tipo_movimiento`, `estado`) VALUES
(1, 'AL', '13', 'ASIGNACION POR LOTES', 1),
...
--
ALTER TABLE `asignacion_equipo`
  MODIFY `id_asignacion_equipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `asignar`
--
ALTER TABLE `asignar`
  MODIFY `id_asignar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `historico_equipo`
  MODIFY `id_historico_equipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
